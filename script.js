...
// get arrays from local storage if available, set default valued if not
...
// reset HTML, filter arrays, update localStorage
function updateDOM() {
    if (!updatedOnLoad) {
        getSavedColumns();
    }
...
// update or delete item, update array value
